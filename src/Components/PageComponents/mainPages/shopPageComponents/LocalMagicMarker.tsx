      ...
      <Container>
        ...
        <div className="space-y-7">
          <div className="flex justify-between items-center">
            ...
            <div className="flex justify-end gap-1 items-center border border-primary-green px-2 py-2 rounded-[6px] w-[350px]">
              <SearchSvg />
              <input
                type="text"
          ...
          {/* Lower Part */}
          <div className="grid grid-cols-2 gap-5 border border-gray-100 rounded-lg p-3">
            {/* Left */}
            {searchShop ? (
              <div className="space-y-2 h-[550px] overflow-y-auto">
                {data?.map(item => (
                  <div
                    key={item?.id}
                    className="flex gap-5 items-center border-b last:border-b-0 border-gray-300 py-3"
                  >
                    {/* shop Image */}
                    ...
                    <div className="flex gap-5 items-center grow">
                      ...
                      <div className="w-[212px] shrink-0 text-sm text-gray-600">
              ...
              <div className="flex flex-col justify-center h-full p-8">
                ...
                <p className="text-secondary-black text-lg mb-5">
