              ...
              <Container>
                ...
                >
                  <div className="w-[560px] bg-[rgba(246,245,240,0.90)] rounded-2xl px-8 py-12 shadow-[0_3px_8px_0_rgba(0,0,0,0.09),_0_3px_12px_0_rgba(0,0,0,0.10)]">
                    ...
                    <button className="w-[416px] hover:bg-primary-green hover:text-white duration-500 transition-all mx-auto block border text-lg text-secondary-black cursor-pointer py-4 bg-accent-white rounded-lg shadow-lg hover:scale-105">
                      {item?.btn_text}
                    </button>
                  </div>
                </div>
